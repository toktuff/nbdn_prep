...
namespace nothinbutdotnetprep.collections
{
    public class MovieLibrary
    {
        ...
        public IEnumerable<Movie> sort_all_movies_by_movie_studio_and_year_published()
        {
            ...
            var rating = new Dictionary<ProductionStudio, int> { { ProductionStudio.MGM, 1 }, { ProductionStudio.Pixar, 2 }, { ProductionStudio.Dreamworks, 3 }, { ProductionStudio.Universal, 4 }, { ProductionStudio.Disney, 5 } };
